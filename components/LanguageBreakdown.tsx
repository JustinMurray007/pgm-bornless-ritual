  ...
  return (
    <aside className="breakdown-panel">
      <header className="breakdown-header">
        <h2 className="breakdown-title">Language Breakdown</h2>
        <p className="breakdown-subtitle">The layers of power encoded in the ritual</p>
      </header>
      ...
      <div className="breakdown-layer">
        ...
        <dl className="breakdown-terms">
          <div className="breakdown-term">
            ...
            <dd>
              Literally "Headless." In the 4th century, this referred to a supreme,
              transcendent deity — the "Head" of the world who exists beyond it.
            </dd>
          </div>
          <div className="breakdown-term">
            <dt>Osoronnophris <span className="breakdown-greek">(Οσοροννόφρις)</span></dt>
            <dd>
              A Greek corruption of the Egyptian <em>Wsir Wn-nfr</em> ("Osiris the
              Perfected Being"). A "wrapper" for the Egyptian god of the underworld.
            </dd>
          </div>
        </dl>
      </div>
      ...
      <div className="breakdown-layer">
        ...
        <dl className="breakdown-terms">
          <div className="breakdown-term">
            ...
            <dd>
              The Greek phonetic version of the Tetragrammaton (YHWH). Considered the
              most potent vowel sequence in magic.
            </dd>
          </div>
          <div className="breakdown-term">
      ...
      <div className="breakdown-layer">
        ...
        <p className="breakdown-layer-note">
          These are the <em>voces magicae</em> — words intended to be "untranslatable,"
          bypassing human logic to speak directly to the cosmos.
        </p>
        <dl className="breakdown-terms">
          <div className="breakdown-term">
            <dt>Abrasax <span className="breakdown-greek">(Αβρασάξ)</span></dt>
            <dd>
              A Gnostic name for the "Lord of the 365 Heavens." The Greek letters add
              up to 365 in gematria (A=1, B=2, R=100, etc.).
            </dd>
          </div>
          <div className="breakdown-term">
            <dt>Arthexouth / Thiaf</dt>
            <dd>
              "Barbarian names" — phonetic strings likely derived from distorted Egyptian
              or Semitic phrases, intended to sound foreign and otherworldly.
            </dd>
          </div>
        </dl>
      </div>
      ...
      <div className="breakdown-layer">
        ...
        <dl className="breakdown-terms">
          <div className="breakdown-term">
            <dt>
              A E Ē I O U Ō{' '}
              <span className="breakdown-greek">(α ε η ι ο υ ω)</span>
            </dt>
            <dd>
              The seven Greek vowels. To the ancients, these were the musical notes of
              the spheres — each representing one of the seven planets: Sun, Moon,
